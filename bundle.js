...
/***/ function(module, exports, __webpack_require__) {
	...
	var reactiveComponent = __webpack_require__(159).reactiveComponent;
	...
	var MonadObject = function MonadObject(ob) {
	  var _this2 = this;

	  _classCallCheck(this, MonadObject);

	  this.x = _mobservable2['default'].makeReactive(ob);
	  ...
	  this.bnd = function (func) {
	    ...
	    return func.apply(undefined, [_this2.x].concat(args));
	  };

	  this.ret = function (w) {
	    Object.assign(_this2.x, w);
	    return _this2;
	  };
	};

	var MonadArray = function MonadArray(z) {
	  var _this3 = this;

	  _classCallCheck(this, MonadArray);
	  ...
	  this.bnd = function (func) {
	    ...
	    return func.apply(undefined, [_this3.x].concat(args));
	  };
	...
	var B2 = (function (_React$Component) {
	  ...
	  function B2(props) {
	    ...
	    this.fibCalc = function (_ref) {
	      ...
	      _this4.ma1.x.replace([a + b, a, c + 1]);
	      return new MonadArray(_this4.ma1.x);
	    };

	    this.add1Calc = function (_ref3) {
	      ...
	      _this4.ma2.x.replace([a + 1, b + 1, c + 1]);
	      return new MonadArray(_this4.ma2.x);
	    };

	    this.mult10Calc = function (_ref4) {
	      ...
	      _this4.ma2.x.replace([a * 10, b * 10, c * 10]);
	      return new MonadArray(_this4.ma2.x);
	    };

	    this.add1_mult10_Calc = function (x) {
	      var d = _this4.add1Calc(x);
	      d.bnd(_this4.mult10Calc);
	    };

	    this.obDouble = function (x) {
	      for (var o in x) {
	        x[o] = x[o] + x[o];
	      }
	    ...
	    this.render = function () {
	      ...
	      var cr67 = _this4.mouse[67];
	      var cr670 = _this4.mouse[670];
	      var cr68 = _this4.mouse[68];
	      var cr77 = _this4.mouse[77];
	      var cr770 = _this4.mouse[770];
	      var cr78 = _this4.mouse[78];
	      var cr87 = _this4.mouse[87];
	      var cr870 = _this4.mouse[870];
	      var cr88 = _this4.mouse[88];
	      var cr97 = _this4.mouse[97];
	      var cr970 = _this4.mouse[970];
	      var cr98 = _this4.mouse[98];
	      var cr107 = _this4.mouse[107];
	      var cr1070 = _this4.mouse[1070];
	      var cr108 = _this4.mouse[108];
	      var cr117 = _this4.mouse[117];
	      var cr1170 = _this4.mouse[1170];
	      var cr118 = _this4.mouse[118];
	      var cr127 = _this4.mouse[127];
	      var cr1270 = _this4.mouse[1270];
	      var cr128 = _this4.mouse[128];
	      var cr137 = _this4.mouse[137];
	      var cr1370 = _this4.mouse[1370];
	      var cr138 = _this4.mouse[138];

	      return _react2['default'].createElement(
	        'div',
	        { style: { backgroundColor: '#000', height: 8800, width: '100%', color: '#FFE4C4', fontSize: 24 } },
	        _react2['default'].createElement(
	          'div',
	          { style: { width: '30%', fontSize: 24, position: 'fixed', top: 300, right: 5 } },
	          _react2['default'].createElement(
	            'span',
	            null,
	            ' Monad mo1 ',
	        ...
	        _react2['default'].createElement(
	          ...
	          'Instances of MonadObject seem to be behaving just like Haskell monads ',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'The functions used by \'bnd\' are maps from values to MonadObject instances. If m be an instance of MonadObject with value a. Then m.bnd(f) returns a new instance of MonadObject with a new value determined by f(a). ',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'The result of this activity inside of m is that, for all practical purposes, m is no different than before, except that its value has changed. This is reminiscent of Haskell\'s MVar, which doesn\'t exactly get mutated although its value can be removed and replaced. ',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          '\'m.ret\' is defined to take an argument and make it the new value of m. As we see in the first example below, binding \'ret\' to mo1 has no effect. It would be inconvenient to show the code here since object brackets, even inside of quotation marks, are treated as code. The code is at ',
	          _react2['default'].createElement(
	            'a',
	            { href: 'https://github.com/dschalk/mobservable-monads', style: { color: '#f26d6d' } },
	            'https://github.com/dschalk/mobservable-monads'
	          ),
	          '. Instead of showing the precise code for objects, I will just write out what they contain.',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'Example 1, illustrating the right identity property of monads.',
	          _react2['default'].createElement('br', null),
	          ...
	          _react2['default'].createElement(
	            ...
	            { style: _this4.style8(cr77, cr770, cr78), onClick: function () {
	                _this4.mo1.bnd(_this4.obDouble).bnd(_this4.mo1.ret).bnd(_this4.obTripple);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[77] = 'blue', _this4.mouse[770] = 'lightblue', _this4.mouse[78] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[77] = '#000', _this4.mouse[770] = 'darkred', _this4.mouse[78] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement(
	            ...
	            { style: _this4.style8(cr87, cr870, cr88), onClick: function () {
	                _this4.mo1.ret({ a: 10, b: 20, c: 30 }).bnd(_this4.obDouble);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[87] = 'blue', _this4.mouse[870] = 'lightblue', _this4.mouse[88] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[87] = '#000', _this4.mouse[870] = 'darkred', _this4.mouse[88] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement(
	            ...
	            ' ',
	            _this4.obDouble({ a: 10, b: 20, c: 30 }).x.a,
	            ' ',
	            _this4.obDouble({ a: 10, b: 20, c: 30 }).x.b,
	            '  ',
	            _this4.obDouble({ a: 10, b: 20, c: 30 }).x.c
	          ),
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'Example 4, illustrating right identity in conjunction with \'Example 1\', and ',
	          _react2['default'].createElement('br', null),
	          'illustrating the associative property of MonadObject instances in conjucntion with \'Example 5\'.',
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr97, cr970, cr98), onClick: function () {
	                _this4.mo1.bnd(_this4.obDouble).bnd(_this4.obTripple);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[97] = 'blue', _this4.mouse[970] = 'lightblue', _this4.mouse[98] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[97] = '#000', _this4.mouse[970] = 'darkred', _this4.mouse[98] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          '   let d = this.obTripple(x); ',
	          _react2['default'].createElement('br', null),
	          'd.bnd(this.obDouble(d.x));',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          ' Compare this with \'Example 4\' which first binds to \'obTripple\' and subsequently binds to \'obDouble\'..',
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr107, cr1070, cr108), onClick: function () {
	                _this4.mo1.bnd(_this4.obSixTimes);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[107] = 'blue', _this4.mouse[1070] = 'lightblue', _this4.mouse[108] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[107] = '#000', _this4.mouse[1070] = 'darkred', _this4.mouse[108] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr117, cr1170, cr118), onClick: function () {
	                _this4.mo1.ret({ a: 1, b: 2, c: 3 });
	              },
	              onMouseEnter: function () {
	                _this4.mouse[117] = 'blue', _this4.mouse[1170] = 'lightblue', _this4.mouse[118] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[117] = '#000', _this4.mouse[1170] = 'darkred', _this4.mouse[118] = 'burlywood';
	              }
	            },
	            'Click to see "this.mo1.ret(object with values 1, 2, and 3)".',
	            _react2['default'].createElement('br', null),
	            'Note: using object notation confuses React.'
	          ),
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr127, cr1270, cr128), onClick: function () {
	                _this4.mo2.ret({ a: 1, b: 2, c: 3 }).bnd(_this4.mo1.ret).bnd(_this4.obReplace, { a: 'one', b: 'two', c: 'three' });
	              },
	              onMouseEnter: function () {
	                _this4.mouse[127] = 'blue', _this4.mouse[1270] = 'lightblue', _this4.mouse[128] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[127] = '#000', _this4.mouse[1270] = 'darkred', _this4.mouse[128] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr137, cr1370, cr138), onClick: function () {
	                _this4.mo1.ret({ a: 'one', b: 'two', c: 'three' }).bnd(_this4.mo2.ret).bnd(_this4.obReplace, { a: 'four', b: 'five', c: 'six' }).bnd(_this4.mo3.ret).bnd(_this4.obReplace, { a: 'SEVEN', b: 'five', c: 'six' });
	              },
	              onMouseEnter: function () {
	                _this4.mouse[137] = 'blue', _this4.mouse[1370] = 'lightblue', _this4.mouse[138] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[137] = '#000', _this4.mouse[1370] = 'darkred', _this4.mouse[138] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr37, cr370, cr38), onClick: function () {
	                _this4.mo1.ret({ a: 3, b: 3, c: 3 }).bnd(_this4.mo2.ret).bnd(_this4.obCube).bnd(_this4.mo3.ret).bnd(_this4.obReplace, { a: 'Done', b: 'b', c: 'c' });
	              },
	              onMouseEnter: function () {
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr97, cr970, cr98), onClick: function () {
	                _this4.m.bnd(_this4.mAdd, 1).bnd(_this4.mAdd, 3).bnd(_this4.fmSquare).bnd(_this4.mAdd, 1).bnd(_this4.fmSquare).bnd(_this4.mAdd, 7);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[97] = 'blue', _this4.mouse[970] = 'lightblue', _this4.mouse[98] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr107, cr1070, cr108), onClick: function () {
	                _this4.m.ret(42).bnd(_this4.m.x);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[107] = 'blue', _this4.mouse[1070] = 'lightblue', _this4.mouse[108] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr127, cr1270, cr128), onClick: function () {
	                _this4.m.bnd(_this4.m.ret).bnd(_this4.m2.x);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[127] = 'blue', _this4.mouse[1270] = 'lightblue', _this4.mouse[128] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr137, cr1370, cr138), onClick: function () {
	                _this4.m.bnd(_this4.mAdd, 1).bnd(_this4.fmSquare);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[137] = 'blue', _this4.mouse[1370] = 'lightblue', _this4.mouse[138] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            ...
	            { style: _this4.style8(cr27, cr270, cr28), onClick: function () {
	                _this4.m.bnd(_this4.fmAdd_then_Square);
	              },
	              onMouseEnter: function () {
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr67, cr670, cr68), onClick: function () {
	                _this4.m2.bnd(_this4.reset_3);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[67] = 'blue', _this4.mouse[670] = 'lightblue', _this4.mouse[68] = 'yellow';
	              },
	              onMouseLeave: function () {
	                _this4.mouse[67] = '#000', _this4.mouse[670] = 'darkred', _this4.mouse[68] = 'burlywood';
	              }
	            },
	          ...
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'I don\'t know if manipulating mobservable reactive entities in this manner will have any practical value. Perhaps chaining, as in "this.m.bnd(this.mAdd,1).bnd(this.mAdd,3).bnd(this.fmSquare) .bnd(this.m2).bnd(this.mAdd,1).bnd(this.fmSquare).bnd(this.mAdd,7)"(see above), will be useful, perhaps as an alternative to promises for assuring that sychronous operations execute in a specified order.',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'It was the realization that mobservable reactive primitives provide access their current as well as their previous values that got me started on this investigation. Some Haskell monads - notably the state monad - hold their current and previous values.     ',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'The monad laws are:',
	          _react2['default'].createElement('br', null),
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr77, cr770, cr78), onClick: function () {
	                _this4.m.ret('Hello').bnd(_this4.m);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[77] = 'blue', _this4.mouse[770] = 'lightblue', _this4.mouse[78] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr97, cr970, cr98), onClick: function () {
	                _this4.m2.ret(' World').bnd(_this4.m2);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[97] = 'blue', _this4.mouse[970] = 'lightblue', _this4.mouse[98] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr87, cr870, cr88), onClick: function () {
	                _this4.m.bnd(_this4.mAdd, _this4.m2.x()).bnd(_this4.m3).bnd(_this4.reset_1);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[87] = 'blue', _this4.mouse[870] = 'lightblue', _this4.mouse[88] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr37, cr370, cr38), onClick: function () {
	                _this4.ma1.bnd(_this4.fibCalc).bnd(_this4.ma1.ret);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[37] = 'blue', _this4.mouse[370] = 'lightblue', _this4.mouse[38] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          ' ".bind(this.ma1.ret)" at the end does not affect the result, confirming that the monad right identity law holds in this instance.',
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr47, cr470, cr48), onClick: function () {
	                _this4.ma1.ret([1, 1, 3]).bnd(_this4.fibCalc);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[47] = 'blue', _this4.mouse[470] = 'lightblue', _this4.mouse[48] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr57, cr570, cr58), onClick: function () {
	                _this4.ma2.bnd(_this4.add1Calc).bnd(_this4.mult10Calc);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[57] = 'blue', _this4.mouse[570] = 'lightblue', _this4.mouse[58] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement(
	            'button',
	            { style: _this4.style8(cr67, cr670, cr68), onClick: function () {
	                _this4.ma2.bnd(_this4.add1_mult10_Calc);
	              },
	              onMouseEnter: function () {
	                _this4.mouse[67] = 'blue', _this4.mouse[670] = 'lightblue', _this4.mouse[68] = 'yellow';
	              },
	          ...
	          _react2['default'].createElement('br', null),
	          _react2['default'].createElement('br', null),
	          'The power of mobservable reactive buttons is showcased at ',
	          _react2['default'].createElement(
	            'a',
	            { href: 'http://schalk.ninja', style: { color: '#f26d6d' } },
	            'http://schalk.ninja'
	          )
	        )
	      );
